Feature: Tag
  ...
  @user1 @web
  Scenario: AS a user I login and then I create  tag
    ...
    And I enter "Tag 1" into input field having css selector ".ember-text-field.gh-input.ember-view"
