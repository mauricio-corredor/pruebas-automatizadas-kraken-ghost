#Escenario # 24
Feature: tags
    As an user I create a tag with random text with long strings
...
Scenario: Login with right data and faker post
  Given I go to ghost home screen
    ...
    And I write random text on element having css selector ".ember-text-field.gh-input.ember-view"
